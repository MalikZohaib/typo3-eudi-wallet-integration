...
return [
    ...
    'columns' => [
        ...
        'store_verification_result' => [
            ...
            'description' => 'Optional audit persistence. Age mode requests only age_over_18. Enable only if your privacy/data-retention policy allows storing the verification result.',
            'config' => ['type' => 'check', 'renderType' => 'checkboxToggle', 'default' => 0],
        ],
    ],
];
